...
export const Twitter = ({ className }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M22 4s-.7 2.1-2 3.4c1.6 1.4 3.3 4.4 3.3 4.4s-1.4 1.4-2.8 2.1c.1.1.2.2.2.3 0 3.4-2.8 7.4-8.8 7.4-3 0-5.2-1.1-6.6-2.1 2 .2 4.1-.4 5.6-1.8-2.1-.1-3.8-1.5-4.4-3.5.5.1 1 .2 1.5.2-1.8-.4-3.2-2-3.2-4.1 0 0 .5.3 1.1.3-1.6-1.1-2.8-3.5-2.8-5.6 0 0 2.1 4.1 7.2 4.1 0 0-2.1-6.1 4.1-6.1 2.3 0 3.9 1 4.6 1.8.6-.1 1.9-.7 1.9-.7s.3 1.1 1.4 2.1c.9-.1 1.7-.5 1.7-.5z"></path>
  </svg>
);
